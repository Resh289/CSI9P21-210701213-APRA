...
namespace BackgroundProcess
{
    public class CodedWorkflow : CodedWorkflowBase
    {
        ...
        {
            _ = new System.Type[]{typeof(UiPath.Core.Activities.API.ISystemService), typeof(UiPath.Excel.Activities.API.IExcelService), typeof(UiPath.Mail.Activities.Api.IMailService)};
        }
